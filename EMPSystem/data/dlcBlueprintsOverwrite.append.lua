...
systemsToAppend["empgenerator"] = {
    ...
    image_list = { 
        ...
        { room_image = "room_empgenerator_19", w = 2, h = 2, top = "01", bottom = "01", left = "11", right = "00", manning_slot = 2, manning_direction = "left" },
        { room_image = "room_empgenerator_24", w = 2, h = 2, top = "10", bottom = "00", left = "00", right = "01", manning_slot = 0, manning_direction = "up" },
        { room_image = "room_empgenerator_25", w = 2, h = 2, top = "01", bottom = "00", left = "01", right = "00", manning_slot = 2, manning_direction = "left" },
        { room_image = "room_empgenerator_24",  w = 2, h = 2, top = "00", bottom = "01", left = "10", right = "00", manning_slot = 3, manning_direction = "down" },
        { room_image = "room_empgenerator_25", w = 2, h = 2, top = "00", bottom = "10", left = "00", right = "10", manning_slot = 1, manning_direction = "right" },
        { room_image = "room_empgenerator_26",  w = 2, h = 2, top = "00", bottom = "11", left = "00",  right = "00",  manning_slot = 3, manning_direction = "down" },
        { room_image = "room_empgenerator_27", w = 2, h = 2, top = "00", bottom = "00", left = "00", right = "11", manning_slot = 3, manning_direction = "right" },
        { room_image = "room_empgenerator_14", w = 2, h = 1, top = "00", bottom = "11", left = "0", right = "0", manning_slot = 1, manning_direction = "down" },
        { room_image = "room_empgenerator_3", w = 2, h = 1, top = "11", bottom = "00", left = "0", right = "0", manning_slot = 1, manning_direction = "up" },
        { room_image = "room_empgenerator_10", w = 1, h = 2, top = "0", bottom = "0", left = "00",  right = "11",  manning_slot = 1, manning_direction = "right" },
        { room_image = "room_empgenerator_6", w = 1, h = 2, top = "0", bottom = "0", left = "11",  right = "00",  manning_slot = 1, manning_direction = "left" },
